...
**How to apply:**
- Do NOT design features that assume "signed-in = free unlimited." Current server.py treats signed-in as unlimited — that's a **placeholder** pending IAP integration (tracked in `tech_debt.md`).
