...
class Settings:
    ...
    aimlapi_generate_path: str = os.environ.get("AIMLAPI_GENERATE_PATH", "/generate/video/google/generation")
    aimlapi_status_path: str = os.environ.get("AIMLAPI_STATUS_PATH", "/generate/video/google/generation")
