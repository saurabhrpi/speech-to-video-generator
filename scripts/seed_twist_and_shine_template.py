"""Seed the Firestore template registry with the Twist and Shine fixture (S77).
...
Re-running overwrites the Twist and Shine doc.

Usage:
    .venv/bin/python scripts/seed_twist_and_shine_template.py
"""
...
log = logging.getLogger("seed_twist_and_shine_template")


TEMPLATE_ID = "viral-dances-twist-and-shine"
...
TWIST_AND_SHINE_FIXTURE = {
    "pipeline_class": PIPELINE_MOTION_TRANSFER,
    "outcome": OUTCOME_ONTO_CHARACTER,
    "category": "iconic_dances",
    "title": "Twist and Shine",
    "description": "Twist, shine, repeat. ✨",
    "published_status": STATUS_DRAFT,
    "assets": {
        "driving_video_url": "https://assets.speech-2-video.ai/viral-dances/twist-and-shine/driving_video.mp4",
        "scene_image_url": None,
        "thumbnail_url": None,
        "preview_video_url": "https://assets.speech-2-video.ai/viral-dances/twist-and-shine/preview_video.mp4",
    },
...
def main() -> None:
    ...
    written = upsert_template(TEMPLATE_ID, TWIST_AND_SHINE_FIXTURE)
    log.info(
