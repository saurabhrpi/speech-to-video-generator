"""Seed the Firestore template registry with the Beat It fixture (S70).

Sister to scripts/seed_baby_dance_template.py. Pipeline A (motion-onto-character
via Kling Motion Control), use_nbp_regen=true with the same generic full-body
framing hint we use for Bombale, Gangsta, and Baby Dance.
...
Re-running overwrites the Beat It doc.

Usage:
    .venv/bin/python scripts/seed_beat_it_template.py
"""
...
log = logging.getLogger("seed_beat_it_template")


TEMPLATE_ID = "viral-dances-beat-it"
...
BEAT_IT_FIXTURE = {
    ...
    "category": "mj_dances",
    "title": "Beat It",
    "description": "Iconic dance, smoother than ever. 🕺⚡",
    "published_status": STATUS_DRAFT,
    "assets": {
        "driving_video_url": "https://assets.speech-2-video.ai/viral-dances/beat-it/driving_video.mp4",
        "scene_image_url": None,
        "thumbnail_url": None,
        "preview_video_url": "https://assets.speech-2-video.ai/viral-dances/beat-it/preview_video.mp4",
    },
...
def main() -> None:
    ...
    written = upsert_template(TEMPLATE_ID, BEAT_IT_FIXTURE)
    log.info(
