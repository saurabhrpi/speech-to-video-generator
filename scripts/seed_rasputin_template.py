"""Seed the Firestore template registry with the Rasputin fixture (S75).

Sister to scripts/seed_baby_dance_template.py. Pipeline A
...
Re-running overwrites the Rasputin doc.

Usage:
    .venv/bin/python scripts/seed_rasputin_template.py
"""
...
log = logging.getLogger("seed_rasputin_template")


TEMPLATE_ID = "viral-dances-rasputin"
...
RASPUTIN_FIXTURE = {
    ...
    "title": "Rasputin",
    "description": "Cool, composed, cinematic. 🕺",
    "published_status": STATUS_DRAFT,
    "assets": {
        "driving_video_url": "https://assets.speech-2-video.ai/viral-dances/rasputin/driving_video.mp4",
        "scene_image_url": None,
        "thumbnail_url": None,
        "preview_video_url": "https://assets.speech-2-video.ai/viral-dances/rasputin/preview_video.mp4",
    },
...
def main() -> None:
    ...
    written = upsert_template(TEMPLATE_ID, RASPUTIN_FIXTURE)
    log.info(
