"""Seed the Firestore template registry with the Thriller fixture (S73).
...
framing hint we use for Bombale, Gangsta, Baby Dance, Beat It, Bad, and Smooth Criminal.

Category: mj_dances (fourth MJ template).
...
Re-running overwrites the Thriller doc.

Usage:
    .venv/bin/python scripts/seed_thriller_template.py
"""
...
log = logging.getLogger("seed_thriller_template")


TEMPLATE_ID = "viral-dances-thriller"
...
THRILLER_FIXTURE = {
    ...
    "category": "mj_dances",
    "title": "Thriller",
    "description": "Iconic zombie moves, sharp rhythms, midnight energy. 🧟⚡",
    "published_status": STATUS_DRAFT,
    "assets": {
        "driving_video_url": "https://assets.speech-2-video.ai/viral-dances/thriller/driving_video.mp4",
        "scene_image_url": None,
        "thumbnail_url": None,
        "preview_video_url": "https://assets.speech-2-video.ai/viral-dances/thriller/preview_video.mp4",
    },
...
def main() -> None:
    ...
    written = upsert_template(TEMPLATE_ID, THRILLER_FIXTURE)
    log.info(
